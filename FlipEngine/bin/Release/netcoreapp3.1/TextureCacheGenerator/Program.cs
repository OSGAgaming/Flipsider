...
namespace TextureCacheGenerator
{
    class Program
    {
        ...
        public static string TextureCachePath => Environment.ExpandEnvironmentVariables($@"{Environment.CurrentDirectory}\Content");
        ...
        public static string AssetDirectory => $@"{MainDirectory}\Textures";
        public static string MainDirectory => Environment.ExpandEnvironmentVariables($@"{Environment.CurrentDirectory}\bin\Release\netcoreapp3.1\Content");
