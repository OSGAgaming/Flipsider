...
{
    public abstract class NetObjSerializer
    {
    ...
    public abstract class NetObjSerializer<T> : NetObjSerializer
    {
        ...
        public sealed override object ReadObj(BinaryReader reader) => Read(reader) ?? throw new ArgumentException($"Unable to read null object");
    }
}