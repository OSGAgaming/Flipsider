...
namespace Flipsider
{
    public static class Extensions
    {
        ...
        public static Point ToScreen(this Point v) => (v.ToVector2() / Main.Gamecamera.Scale + Main.Gamecamera.Position).ToPoint();
        public static Point ToDestinationScreen(this Point v) => ((v.ToVector2() / Main.Gamecamera.Scale) + Main.Gamecamera.Position).ToPoint();
        public static Vector2 AddParallaxAcrossX(this Vector2 v, float traversingPixels)
       =>
            v - new Vector2(Math.Clamp(Main.Gamecamera.EntityIsolatedPosition.X * traversingPixels, -100000, 100000), 0);
        ...
        {
            float traverseFunction = Math.Clamp(Main.Gamecamera.EntityIsolatedPosition.Y * traversingPixels, -100000, 100000);
            return v - new Vector2(0, traverseFunction);
        }

        public static Vector2 AddParallaxAcrossXY(this Vector2 v, Vector2 traversingPixels)
        {
            return v - Main.Gamecamera.EntityIsolatedPosition * traversingPixels;
        }
