#nullable disable
// Auto-generated code.
// Generated using TextureCacheGenerator.
...
public static Texture2D _Backgrounds_CityBackground1;
public static Texture2D _Backgrounds_CityBackground2;
...
public static Texture2D _BodyParts_bitch_body;
public static Texture2D _BodyParts_bitch_head;
public static Texture2D _BodyParts_bitch_lower_left_arm;
public static Texture2D _BodyParts_bitch_lower_left_leg;
public static Texture2D _BodyParts_bitch_lower_right_arm;
public static Texture2D _BodyParts_bitch_lower_right_leg;
public static Texture2D _BodyParts_bitch_upper_left_arm;
public static Texture2D _BodyParts_bitch_upper_left_leg;
public static Texture2D _BodyParts_bitch_upper_right_arm;
public static Texture2D _BodyParts_bitch_upper_right_leg;
public static Texture2D _BodyParts_BodyAnim;
public static Texture2D _BodyParts_hair_color_palette ;
public static Texture2D _BodyParts_HeadAnim;
public static Texture2D _BodyParts_LeftArm;
public static Texture2D _BodyParts_LeftArmR;
public static Texture2D _BodyParts_LeftLeg;
public static Texture2D _BodyParts_LeftLegR;
public static Texture2D _BodyParts_Ponytail ;
public static Texture2D _BodyParts_ref;
public static Texture2D _BodyParts_RightArm;
public static Texture2D _BodyParts_RightArmR;
public static Texture2D _BodyParts_RightLeg;
public static Texture2D _BodyParts_RightLegR;
...
public static Texture2D _Props_City_RoofBuilding1;
public static Texture2D _Props_City_RoofBuilding1BoxFront;
public static Texture2D _Props_City_RoofBuilding1Front;
public static Texture2D _Props_City_WideRoof1;
...
_Backgrounds_CityBackground1 = AutoloadTextures.Assets[@"Backgrounds\CityBackground1"];
_Backgrounds_CityBackground2 = AutoloadTextures.Assets[@"Backgrounds\CityBackground2"];
...
_BodyParts_bitch_body = AutoloadTextures.Assets[@"BodyParts\bitch_body"];
_BodyParts_bitch_head = AutoloadTextures.Assets[@"BodyParts\bitch_head"];
_BodyParts_bitch_lower_left_arm = AutoloadTextures.Assets[@"BodyParts\bitch_lower_left_arm"];
_BodyParts_bitch_lower_left_leg = AutoloadTextures.Assets[@"BodyParts\bitch_lower_left_leg"];
_BodyParts_bitch_lower_right_arm = AutoloadTextures.Assets[@"BodyParts\bitch_lower_right_arm"];
_BodyParts_bitch_lower_right_leg = AutoloadTextures.Assets[@"BodyParts\bitch_lower_right_leg"];
_BodyParts_bitch_upper_left_arm = AutoloadTextures.Assets[@"BodyParts\bitch_upper_left_arm"];
_BodyParts_bitch_upper_left_leg = AutoloadTextures.Assets[@"BodyParts\bitch_upper_left_leg"];
_BodyParts_bitch_upper_right_arm = AutoloadTextures.Assets[@"BodyParts\bitch_upper_right_arm"];
_BodyParts_bitch_upper_right_leg = AutoloadTextures.Assets[@"BodyParts\bitch_upper_right_leg"];
_BodyParts_BodyAnim = AutoloadTextures.Assets[@"BodyParts\BodyAnim"];
_BodyParts_hair_color_palette  = AutoloadTextures.Assets[@"BodyParts\hair_color_palette "];
_BodyParts_HeadAnim = AutoloadTextures.Assets[@"BodyParts\HeadAnim"];
_BodyParts_LeftArm = AutoloadTextures.Assets[@"BodyParts\LeftArm"];
_BodyParts_LeftArmR = AutoloadTextures.Assets[@"BodyParts\LeftArmR"];
_BodyParts_LeftLeg = AutoloadTextures.Assets[@"BodyParts\LeftLeg"];
_BodyParts_LeftLegR = AutoloadTextures.Assets[@"BodyParts\LeftLegR"];
_BodyParts_Ponytail  = AutoloadTextures.Assets[@"BodyParts\Ponytail "];
_BodyParts_ref = AutoloadTextures.Assets[@"BodyParts\ref"];
_BodyParts_RightArm = AutoloadTextures.Assets[@"BodyParts\RightArm"];
_BodyParts_RightArmR = AutoloadTextures.Assets[@"BodyParts\RightArmR"];
_BodyParts_RightLeg = AutoloadTextures.Assets[@"BodyParts\RightLeg"];
_BodyParts_RightLegR = AutoloadTextures.Assets[@"BodyParts\RightLegR"];
...
_Props_City_RoofBuilding1 = AutoloadTextures.Assets[@"Props\City\RoofBuilding1"];
_Props_City_RoofBuilding1BoxFront = AutoloadTextures.Assets[@"Props\City\RoofBuilding1BoxFront"];
_Props_City_RoofBuilding1Front = AutoloadTextures.Assets[@"Props\City\RoofBuilding1Front"];
_Props_City_WideRoof1 = AutoloadTextures.Assets[@"Props\City\WideRoof1"];
