...
namespace FlipEngine
{
    internal class NPCScreen : ModeScreen
    {
        ...
        public override void CustomDrawToScreen()
        {
            ...
            {
                FlipGame.spriteBatch.Draw(icon, FlipGame.MouseToDestination().ToVector2(), icon?.Bounds, Color.White * Math.Abs(Time.SineTime(3f)), 0f, (icon ?? FlipTextureCache.pixel).TextureCenter(), 1f, SpriteEffects.None, 0f);
            }
        }
